...
.biaoming{text-align: center;font-size: 15px;margin-bottom: 3px;}
        </style>
<title>水电气实时统计</title>
</head>
...
<!--账户基本信息-->
 ...
 <div class="recording_style">
    <div id="recording">
        ...
        <div class="bd">
                <ul>
                <div class="biaoming">表名：<span>水表</span></div>
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                 ...
                 <!--     <c:if test="${!empty water }">
                    ...
                    <tr>
                          <td>${water.time}</td>
                          <td><a href="javascript:;" onclick="kantuwater()" ><img class="paizhao" src="${water.picture}"></a></td>
                ...
                <div class="bd">
                <ul>
                <div class="biaoming">表名：<span>电表</span></div>
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                   <thead>
                      <tr>
                 ...
                 <!--    <c:if test="${!empty dian }">
                     <c:forEach items="${dian}" var="dian" varStatus="status">
                         <tr>
                             <td>${dian.time}</td>
                             <td><a href="javascript:;" onclick="kantuwater()" ><img class="paizhao" src="${dian.picture}"></a></td>
                             <td><input type="text" name="water"></td>
                         </tr>
                     </c:forEach>
                 </c:if>-->
        ...
        <div class="bd">
                <ul>
                <div class="biaoming"></span> 表名：<span>气表</span></div>
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                   <thead>
                      <tr>
                 ...
                 <tbody>
                 <!--    <c:if test="${!empty gas }">
                 <c:forEach items="${gas}" var="water" varStatus="status">
                 <tr>
                     <td>${gas.time}</td>
                     <td><a href="javascript:;" onclick="kantuwater()" ><img class="paizhao" src="${gas.picture}"></a></td>
                     <td><input type="text" name="water"></td>
                 </tr>
                 </c:forEach>
                 </c:if>-->
  ...
  <div class="kuang">
    ...
    <div class="tian">
      <ul class="edit_xie">
        ...
        <li><label class="label_name">填写数据：</label><span class="add_name"><input value="" name="数据" type="text"  class="text_add"/></span></li>
      </ul>
