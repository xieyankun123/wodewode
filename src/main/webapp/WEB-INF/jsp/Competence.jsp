  ...
  <div class="left_Competence_add">
   ...
   <div class="Assign_style">
      ...
      <dl class="permission-list">
		<dt><label class="middle"><input name="user-Character-0" class="ace" type="checkbox" id="id-disable-check"><span class="lbl">操作管理员</span></label></dt>
		
	    </dl> 
        <!--图片管理-->
         <dl class="permission-list">
		<dt><label class="middle"><input name="user-Character-0" class="ace" type="checkbox" id="id-disable-check"><span class="lbl">管理租户</span></label></dt>
		<!-- <dd>
        ...
        <!--交易管理--> 
        <dl class="permission-list">
		<dt><label class="middle"><input name="user-Character-0" class="ace" type="checkbox" id="id-disable-check"><span class="lbl">查看租户和管理员信息</span></label></dt>
		<!-- <dd> -->
		 <!-- <dl class="cl permission-list2">
