...
<html>
        ...
        <script>
            ...
            function load(a,b) {
                ...
                $.ajax({	//使用JQuery内置的Ajax方法
                        ...
                        data : {apparatus_id:aa,user_telephone:bb},		//请求内包含一个key为yiqihao，value为shebeihao的参数；
    ...
    <body onload="load('${apparatus_id}','${user_telephone}')">
        <div class="top-nav">
            <button class="btn btn-success" id="button1" onclick="bianse1()">天数视图</button>
            <button id="button2" class="btn" onclick="bianse2()">分钟视图</button>
        </div>
